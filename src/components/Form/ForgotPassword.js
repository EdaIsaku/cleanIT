...
class ForgotPassword extends React.Component{
    ...
    forgotPassword = (mail) => {
        ...
        const {email, errors:{result, message}} = this.state
        auth.sendPasswordResetEmail(mail).then(function(){
            ...
            if(error){
                ...
                this.setState((prevState) =>({
                    ...prevState, errors: {
                        ...prevState.errors, email: {result, message}
                    }
                }))
                return false
            }else {
            ...
            <Fade right duration={600} distance='50px'>
              <div className='form'>
                ...
                <p className='form__subtitle'>
                  Don't worry. . . Just fill in your email <br/> and we'll send you a link to reset your password.
                </p>
                <Input
